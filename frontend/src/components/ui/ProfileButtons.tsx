  ...
  return (
    <div className="bg-white rounded-lg shadow-lg p-6 mb-6">
      <h3 className="text-lg font-bold text-gray-800 mb-4 text-center">
        🎯 Perfiles de Autocompletado Optimizados
      </h3>
      <p className="text-sm text-gray-600 text-center mb-6">
        Haz clic en cualquier perfil para cargar datos optimizados para el
        modelo actual.
        <br />
        <span className="text-amber-600 font-medium">
          Nota: Los perfiles han sido ajustados para compensar las limitaciones
          del modelo.
        </span>
      </p>
      ...
      <div className="mt-4 p-3 bg-blue-50 rounded-lg border border-blue-200">
        <p className="text-xs text-blue-800 text-center">
          ...
          basados en análisis de datos reales. Puedes modificar cualquier campo
